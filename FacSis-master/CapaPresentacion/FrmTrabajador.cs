...
namespace CapaPresentacion
{
    public partial class FrmTrabajador : Form
    {
        ...
        private void Limpiar()
        {
            ...
            cbPerfilUsuario.SelectedIndex = 0;
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (txtBuscar.Text == string.Empty)
            {
                ...
                errorIcono.SetError(txtBuscar, "Seleccione el tipo de busqueda e ingrese los datos a buscar");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtNombre, "Ingrese el nombre del Usuario");
                }
                else if (txtApellido.Text == string.Empty)
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtApellido, "Ingrese el apellido del Usuario");
                ...
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtDireccion, "Ingrese la dirección del Usuario");

                }
                else if (mtxtTelefono.Text == string.Empty)
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(mtxtTelefono, "Ingrese el telefono");

                }
                else if (txtEmail.Text == string.Empty)
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtEmail, "Ingrese el emeil");
                ...
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtPassword, "Ingrese contraseña");

                }
                else if (txtConfirmarPassword.Text == string.Empty || txtConfirmarPassword.Text != txtPassword.Text)
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtConfirmarPassword, "Confirme la contraseña");
                }
                else
                {
                    if (isNuevo)
                    ...
                    if (respuesta.Equals("Ok"))
                    {
                        if (isNuevo)
                        {
                            Utilidades.MensajeOK("El Usuario se agregó correctamente");
                        }
                        else
                        {
                            Utilidades.MensajeOK("La Usuario se editó correctamente");
                        }
                    }
                    else
                    {
                        Utilidades.MensajeError($"No se agrego el Usuario:\n {respuesta}");
                    }
                    isNuevo = false;
                    isEditar = false;
                    HabilitarBotones();
