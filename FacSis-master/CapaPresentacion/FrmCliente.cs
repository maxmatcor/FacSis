    ...
    public partial class FrmCliente : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (txtBuscar.Text == string.Empty)
            {
                ...
                errorIcono.SetError(txtBuscar, "Seleccione el tipo de busqueda y los datos a buscar");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(mtxtTelefono, "Ingrese el telefono del cliente");

                }
                else if (txtEmail.Text == string.Empty)
                {
                    Utilidades.MensajeError("Falta ingresar algunos datos.");
                    errorIcono.SetError(txtEmail, "Ingrese el emeil del cliente");
                ...
                else
                {
                    ...
                    if (respuesta.Equals("Ok"))
                    {
                        ...
                        {
                            Utilidades.MensajeOK("El cliente se editó correctamente");
                        }
                    }
                    else
                    {
        ...
        private bool SetupThePrinting()
        {
            ...
            printDocument1, true, true, this.Text + DateTime.Now.ToShortTimeString() + "  " + DateTime.Now.ToShortDateString() + "  " + "La Casa del Corsa", new Font("Tahoma", 8,
