...
namespace CapaDatos
{
    public class Dingreso
    {
        ...
        #region MetodoFechaMas30
        public DataTable BuscarFechaMas30(string FechaInicio, string FechaFin, string estado)
        {
            //Cadena de conexion y DataTable (tabla)
            var resultadoTabla = new DataTable("ingreso");
            var conexionSql = new SqlConnection(Utilidades.conexion);
            ...
            try
            {
                var comandoSql = new SqlCommand("[spbuscar_ingreso_fecha_30]", conexionSql);
                comandoSql.CommandType = CommandType.StoredProcedure;
                ...
                var parestado = new SqlParameter("@estado", SqlDbType.VarChar, 20);
        ...
        public DataTable BuscarEstado(string estado)
        {
            ...
            try
            {
                var comandoSql = new SqlCommand("[spbuscar_ingreso_estado]", conexionSql);
                comandoSql.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarCliente(string idCliente)
        {
            ...
            try
            {
                var comandoSql = new SqlCommand("[spbuscar_ingreso_cliente]", conexionSql);
                comandoSql.CommandType = CommandType.StoredProcedure;

                //Parametros

                var paridCliente = new SqlParameter("@idCliente", SqlDbType.VarChar, 20);
        ...
        #region MetodoFactura
        public DataTable BuscarFactura(string serie, string factura)
        {
            //Cadena de conexion y DataTable (tabla)
            var resultadoTabla = new DataTable("ingreso");
            var conexionSql = new SqlConnection(Utilidades.conexion);
            ...
            try
            {
                var comandoSql = new SqlCommand("[spbuscar_ingreso_Facturas]", conexionSql);
                comandoSql.CommandType = CommandType.StoredProcedure;

                //Parametros

                var parserie = new SqlParameter("@serie", SqlDbType.VarChar, 20);
                parserie.Value = serie;
                comandoSql.Parameters.Add(parserie);

                var parfactura = new SqlParameter("@factura", SqlDbType.VarChar, 20);
                parfactura.Value = factura;
                comandoSql.Parameters.Add(parfactura);
